...
INSERT INTO atividade(atividade.id_atividade, atividade.carga_horaria, atividade.descricao, atividade.detalhamento, atividade.precisa_calcular, atividade.grupo_id_grupo)
VALUES(1, 1, "Evento_Pesquisa", "detalhamento_1", 0, 1), (2, 2, "Extensão_Amanda", "detalhamento_2", 1, 1), (3, 1, "Aquela PESQUISAAAAA", "detalhamento_3", 1, 2), (4, 2, "Ensinar os amigos", "detalhamento_4", 1, 3), (5, 1, "ADES", "detalhamento_5", 0, 5), (6, 1, "Publicação Foda", "detalhamento_5", 0, 3), (7, 1, "Evento ComPUTAção", "detalhamento_5", 0, 4);
